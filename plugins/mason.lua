...
return {
  ...
  -- use mason-null-ls to configure Formatters/Linter installation for null-ls sources
  {
    ...
    opts = {
      ensure_installed = { 'beautysh', 'black', 'blade-formatter', 'clang-format', 'cmakelang', 'csharier', 'elm-format',
        'fixjson', 'goimports', 'goimports-reviser', 'golines', 'gomodifytags', 'google-java-format', 'gotests', 'isort',
        'joker', 'ktlint', 'luaformatter', 'remark-cli', 'markdownlint', 'prettier', 'rustfmt', 'rustywind',
        'shellharden', 'shfmt', 'snakefmt', 'sql-formatter', 'stylua', 'usort', 'verible', 'xmlformatter', 'yamlfmt',
        'yapf', },
    },
  },
  {
